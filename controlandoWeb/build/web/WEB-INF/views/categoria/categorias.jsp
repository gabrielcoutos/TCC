...
<html lang="pt-br">
    ...
    <body>
                                    ...
                                    <div class="panel-body no-padding">
                                        ...
                                        <form class="form-group"  method="GET">
                                            <div class="input-group">                               
                                                <input type="text" id="searchNome" name="searchNomeP" class="form-control" placeholder="Procure por uma categoria"/>
                                                <div class="input-group-btn"> 
                                                    <a  class="btn btn-primary" href="<c:url value="/categoria/novo"/>" >Novo</a>
                                                </div>
                                            </div>
                                        </form>
        ...
        <script src="<c:url value="/resources/js/categoria/app.js"/>"></script>
    </body>
