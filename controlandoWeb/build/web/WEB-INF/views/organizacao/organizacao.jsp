                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Organização</h3>
                                        <div class="right">
                                            <a  class="btn btn-primary" href="<c:url value="/organizacao/novo"/>" >Novo</a>
                                    ...
                                    <div class="panel-body no-padding">
                                        ...
                                        <!-- Aqui tinha o mÃ©todo get pra realizar buscas -->

                                        <div style="overflow-y: auto;max-height: 500px;">
                                            <c:if test="${empty organizacaoList}">
                                                <strong>Nenhuma organização encontrada</strong>
                                            </c:if>
                                            <c:if test="${not empty organizacaoList}">
                                                <table class="table" id="tableOrganizacao">
                                                    <thead>
                                                        <tr>
                                                            <th>Razão Social</th>
                                                            <th>Nome Fantasia</th>
                                                    ...
                                                    <tbody>
                                                        <c:forEach var="organizacao" items="${organizacaoList}">
                                                            <tr>                                                                
                                                                <td>${organizacao.razaoSocial}</td>
                                                                <td>${organizacao.nome_fantasia}</td>
                                                                <td>${organizacao.cnpj}</td>    
                                                                <td><a class="btn btn-default" href="<c:url value="/organizacao/${organizacao.id}"/>"><i class="glyphicon glyphicon-pencil"></i>Editar</a> 
                                                                    <a class="btn btn-danger" href="<c:url value="/organizacao/${organizacao.id}/deletar"/>"><i class="glyphicon glyphicon-remove"></i>Excluir</a></td>
                                                            </tr>
                                                        </c:forEach>
                                                    </tbody>
                                                </table>
