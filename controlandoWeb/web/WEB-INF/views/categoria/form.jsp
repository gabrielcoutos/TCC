...
<html lang="pt-br">
    ...
    <body>
                        ...
                        <ul class="nav">
                            ...
                            <div class="collapse in" id="collapseBloqueio">
                                <ul class="nav"> 
                                    ...
                                    <li><a href="<c:url value="/categorias"/>" class="active"><i class="glyphicon glyphicon-align-justify"></i> <span>Categorias</span></a></li>
                                </ul>
                            </div>
                        </ul>
                    </nav>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">                                        
                                            <form class="form-group"  method="POST" id="formCategoria">
                                                <div class="form-group">    
                                                    <label>Nome da Categoria: </label>
                                                    <input type="text" id="nomeCategoria" name="nomeCategoria" class="form-control" value="${categoria.nome}"/>
                                                </div>
                                                <div class="form-group">    
                                                    <label>Descricao da Categoria: </label>
                                                    <textarea id="descricao" name="descricao" rows="3" class="form-control"  >${categoria.descricao}</textarea>
                                                </div>                                                                                               
                                                <div class="form-group"> 
        ...
        <script src="<c:url value="/resources/js/categoria/validacao.js"/>"></script>
    </body>
