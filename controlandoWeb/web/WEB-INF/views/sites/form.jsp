...
<html lang="pt-br">
    ...
    <body>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body no-padding">
                                        <div class="container">
                                            <form class="form-group"  method="POST" id="formSite">
                                                <div class="form-group">    
                                                    <label>Nome do Site: </label>
                                                    <input type="text" id="nomeSite" name="nomeSite" class="form-control" value="${site.nome}"/>
                                                </div>
                                                <div class="form-group">    
                                                    <label>Descricao do Site: </label>
                                                    <textarea id="descricao" name="descricao" rows="3" class="form-control"  >${site.descricao}</textarea>
                                                </div>
                                                <div class="form-group">    
                                                    <label>URL do Site: </label>
                                                    <input type="url" id="urlSite" name="urlSite" class="form-control" value="${site.url}"/>
                                                </div>
                                                <div class="form-group">    
                                                    ...
                                                    <select class="form-control" id="selectCategoria" name="selectCategoria">
                                                        ...
                                                        <c:forEach var="categoria" items="${categoriaList}">
                                                            <option value="${categoria.id}" class="form-control" <c:if test="${site.categoria.nome eq categoria.nome}">selected=""</c:if>>${categoria.nome}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                                <div class="form-group"> 
                                                    <input type="submit" value="Aprovar" class="btn btn-primary"/>
                                                </div>
                                            </form>
                                        </div>
        ...
        <script src="<c:url value="/resources/js/site/validacao.js"/>"></script>
    </body>
